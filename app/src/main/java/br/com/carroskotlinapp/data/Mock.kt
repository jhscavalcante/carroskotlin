package br.com.carroskotlinapp.data

import android.content.res.Resources
import android.graphics.Bitmap
import android.graphics.BitmapFactory
import br.com.carroskotlinapp.R
import br.com.carroskotlinapp.domain.Acessorio
import br.com.carroskotlinapp.domain.Carro
import br.com.carroskotlinapp.domain.Marca
import br.com.carroskotlinapp.domain.Motor
import java.util.*
...
class Mock {
    ...
    private fun gerarAcessorio(): Acessorio{
        val nomes = arrayOf(
            "Teto solar", "Multimídia", "Aro 21 (Sport)", "Bancos de couro")
